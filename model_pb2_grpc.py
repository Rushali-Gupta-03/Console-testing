...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetData = channel.unary_unary(
                '/model.ModelService/GetData',
                request_serializer=model__pb2.DataRequest.SerializeToString,
                response_deserializer=model__pb2.DataResponse.FromString,
                _registered_method=True)
...
class ModelServiceServicer(object):
    ...
    def GetData(self, request, context):
        """New method to retrieve data using Arrow Flight protocol
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ModelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetData': grpc.unary_unary_rpc_method_handler(
                    servicer.GetData,
                    request_deserializer=model__pb2.DataRequest.FromString,
                    response_serializer=model__pb2.DataResponse.SerializeToString,
            ),
    }
...
class ModelService(object):
    ...
    def GetData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/model.ModelService/GetData',
            model__pb2.DataRequest.SerializeToString,
            model__pb2.DataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
